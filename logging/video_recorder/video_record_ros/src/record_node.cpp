...
int main(int argc, char** argv)
{
    ...
    if (!nh.getParam("/video_record/topic", topic))
    {
        ROS_WARN("no topic param found");
    }
    if (!nh.getParam("/video_record/path_save", path_save))
    {
    ...
    if (!nh.getParam("/video_record/file_name", file_name))
    {
