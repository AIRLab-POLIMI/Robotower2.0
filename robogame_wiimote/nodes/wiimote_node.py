...
class IMUSender(WiimoteDataSender):
    ...
    def __init__(self, wiiMote, freq=100):
        ...
        self.pub = rospy.Publisher('imu/data', Imu, queue_size=100)        
...
class JoySender(WiimoteDataSender):
    ...
    def __init__(self, wiiMote, freq=100):
        ...
        self.pub = rospy.Publisher('/wiimote/joy', Joy, queue_size=100)        
...
class WiiSender(WiimoteDataSender):
    ...
    def __init__(self, wiiMote, freq=100):
        ...
        self.pub = rospy.Publisher('/wiimote/state', State, queue_size=100)
...
class WiimoteListeners(threading.Thread):
	...
	self.rumbleCommand = False
        ...
        self.is_calibratedPublisher = rospy.Publisher('/imu/is_calibrated', Bool, queue_size=100, latch=True)
