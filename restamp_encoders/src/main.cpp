...
int main (int argc, char** argv){ 	
	...
	ros::init(argc, argv, "robogame_encoder_timestamp");
	ros::NodeHandle nh;
    ...
    pub1 = nh.advertise<r2p::EncoderStamped>("/triskar/stamped_encoder1",1000);
	pub2 = nh.advertise<r2p::EncoderStamped>("/triskar/stamped_encoder2",1000);
	pub3 = nh.advertise<r2p::EncoderStamped>("/triskar/stamped_encoder3",1000);
	// Let ROS take over .
	ros::spin();
}
