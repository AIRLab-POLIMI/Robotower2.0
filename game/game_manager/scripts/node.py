...
__contributors__ = ["Stefano Boriero"]
__license__ = "MIT"
__version__ = "0.0.1"
...
class GameManagerNode(object):
    ...
    def __init__(self):
        ...
        self.difficulties = rospy.get_param("/difficulties")
    ...
    def joy_callback(self, msg):
        ...
        """
        if msg.buttons[5] and msg.buttons[9] and not self.trying_reset:
        ...
        elif msg.buttons[5] and msg.buttons[6] and msg.buttons[0]:
            self.change_difficulty(self.diff_index[1])
        elif msg.buttons[5] and msg.buttons[6] and msg.buttons[1]:
            self.change_difficulty(self.diff_index[2])
        elif msg.buttons[5] and msg.buttons[6] and msg.buttons[2]:
            self.change_difficulty(self.diff_index[3])
