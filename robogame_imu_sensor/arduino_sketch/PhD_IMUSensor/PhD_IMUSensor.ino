...
// data to be seen across the RF module
struct package
{
    //float dt = 0.0;
    float accel_angle_x = 0.0;
    float accel_angle_y = 0.0;
    float accel_angle_z = 0.0;
    float unfiltered_gyro_angle_x = 0.0;
    float unfiltered_gyro_angle_y = 0.0;
    float unfiltered_gyro_angle_z = 0.0;
    float angle_x = 0.0;
    float angle_y = 0.0;
    float angle_z = 0.0;
};
...
typedef struct packageB IMU_Package;
IMU_Package data;
long id = 0;
...
//  float accel_vector_length = sqrt(pow(accel_x,2) + pow(accel_y,2) + pow(accel_z,2));
  ...
  //Filtered angle (complementary filter: gyro + accelerometer)
  ...
  Serial.print(F("#GYR:"));
  Serial.print(data.gyro_x, 2);        //Gyroscope angle
  Serial.print(F(","));
  Serial.print(data.gyro_y, 2);
  Serial.print(F(","));
  Serial.print(data.gyro_z, 2);
  Serial.print(F("#ANG:"));             //Filtered angle
  Serial.print(data.angle_x, 2);
  Serial.print(F(","));
  Serial.print(data.angle_y, 2);
  Serial.println(F(""));
