...
int main(int argc, char** argv){
    ...
    pub_angle_wrt_screen_center = nh.advertise<kinect_tracker::PlayerScreenAngle>("kinect2/player_relative_angle",1);
    pub_ci = nh.advertise<kinect_tracker::ContractionIndex>("kinect2/player_contraction_index",1);
    pub_player_distance = nh.advertise<kinect_tracker::PlayerDistance>("kinect2/player_distance",1);
    pub_pixel_position = nh.advertise<kinect_tracker::PlayerPixelPosition>("kinect2/player_pixel_position",1);
