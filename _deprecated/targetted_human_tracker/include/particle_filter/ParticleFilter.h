...
protected:
     ...
     */
    std::vector<bool> blockObservation(const targetted_human_tracker::PersonArray &people) const;
...
public:
    ...
    virtual void peopleDetectedCallback(const targetted_human_tracker::PersonArray &people);
