...
void ParticleFilter::peopleDetectedCallback(const targetted_human_tracker::PersonArray &msg){
 ...
 */
std::vector<bool> ParticleFilter::blockObservation(const targetted_human_tracker::PersonArray &people) const
{
