...
void MultipleParticleFilter::peopleDetectionCallback(const targetted_human_tracker::PersonArray &people)
{
...
void MultipleParticleFilter::computeAssociations(const targetted_human_tracker::PersonArray &people, AssociationMatrix &association, IntSet &peopleToAssociate)
{
    #pragma omp parallel for
...
void MultipleParticleFilter::updateClouds(const targetted_human_tracker::PersonArray &people, AssociationMatrix &association, IntSet &peopleToAssociate)
{
    #pragma omp parallel for
    for (int i = 0; i < clouds.size(); i++) {
...
void MultipleParticleFilter::createNewClouds(const targetted_human_tracker::PersonArray &people, AssociationMatrix &association, IntSet &peopleToAssociate)
{
...
void MultipleParticleFilter::blobDetectionCallback(const targetted_human_tracker::Blob &person)
{
...
void MultipleParticleFilter::getFovVertices(const targetted_human_tracker::Blob &person, Vec2f &robot, Vec2f &fovLeft, Vec2f &fovRight)
{
