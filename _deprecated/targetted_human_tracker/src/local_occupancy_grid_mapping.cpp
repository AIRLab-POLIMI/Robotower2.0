...
private:
  ...
  message_filters::Subscriber<targetted_human_tracker::LegArray> non_leg_clusters_sub_;
  message_filters::TimeSynchronizer<sensor_msgs::LaserScan, targetted_human_tracker::LegArray> sync;
  ...
  */
  void laserAndLegCallback(const sensor_msgs::LaserScan::ConstPtr& scanMsg, const targetted_human_tracker::LegArray::ConstPtr& non_leg_clusters)
  {
    ...
    if (transform_available)
    {
      ...
      {
        targetted_human_tracker::Leg leg = non_leg_clusters->legs[i];
