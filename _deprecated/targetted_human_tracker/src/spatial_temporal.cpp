#include <targetted_human_tracker/spatial_temporal.h>
#include <exception>
...
{
    targetted_human_tracker::TrackVariance msg;
...
void spatial_temporal::Extractor::legArrayCallback(const targetted_human_tracker::LegArray::ConstPtr &legArrayMsg){
    #pragma omp parallel for
