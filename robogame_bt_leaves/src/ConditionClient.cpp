...
int main (int argc, char **argv)
{
	...
	actionlib::SimpleActionClient<robogame_bt_leaves::BTAction> ac("condition", true);
	...
	bool isRunning = false;
 	...
 	while(command!=3){
	    ...
	    ROS_INFO("Send a command by pressing:\n 1:Evaluate the condition | 3:exit the program");
		std::cin >> command;
